CREATE DATABASE [CigarShopManagementSystem]

GO
USE [CigarShopManagementSystem]
GO 
...
INSERT INTO [Sizes] ([Id], [Length], [RingRange]) 
		VALUES
	(1, 10, 1.8),
	(2, 10, 2.9),
	(3, 10, 3.2),
...
INSERT INTO [Tastes] ([Id], [TasteType], [TasteStrength], [ImageURL]) 
		VALUES
...
INSERT INTO [Brands] ([Id], [BrandName], [BrandDescription]) 
		VALUES
...
INSERT INTO [Addresses] ([Id], [Town], [Country], [Streat], [ZIP]) 
		VALUES
...
INSERT INTO [Clients] ([Id], [FirstName], [LastName], [Email], [AddressId]) 
		VALUES
...
-- Table: ClientsCigars
INSERT INTO [ClientsCigars] ([ClientId], [CigarId]) 
		VALUES
	(1,35),
	(2,34),
	(3,33),
