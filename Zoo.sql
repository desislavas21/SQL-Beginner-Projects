...
INSERT INTO [Owners]([Id], [Name], [PhoneNumber], [Address]) 
		VALUES
...
INSERT INTO [AnimalTypes]([Id], [AnimalType]) 
		VALUES
	(1, 'Mammals'),
	(2, 'Fish'),
	(3, 'Birds'),
...
INSERT INTO [Cages]([Id], [AnimalTypeId]) 
	VALUES
	(1, 2),
	(2, 3),
	(3, 6),
...
INSERT INTO [Animals]([Id], [Name], [BirthDate], [OwnerId], [AnimalTypeId])
		VALUES
...
-- Table: AnimalsCages
INSERT INTO [AnimalsCages]([CageId], [AnimalId]) 
		VALUES
	(1, 13),
	(2, 19),
	(3, 44),
...
INSERT INTO [VolunteersDepartments]([Id], [DepartmentName]) 
		VALUES
	(1, 'Guest engagement'),
...
INSERT INTO [Volunteers]([Id], [Name], [PhoneNumber], [Address], [AnimalId], [DepartmentId]) 
		VALUES
...
SELECT	[v].[Name], [v].[PhoneNumber], 
		 LTRIM(SUBSTRING(LTRIM([v].[Address]), 8, 500)) AS [Address]
...
--10
SELECT	[Name], 
		YEAR([a].[BirthDate]) AS [BirthYear], [at].[AnimalType]
FROM	[Animals] AS [a]
JOIN	[AnimalTypes] AS [at] 
ON		[a].[AnimalTypeId] = [at].[Id]
